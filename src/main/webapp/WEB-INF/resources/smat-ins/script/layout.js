App = {
    ...
    _bindEvents: function() {
        ...
        $(document).off('click.correspondence').on('click.correspondence', function(event) {
        ...
        this.filterPanel.off('click.correspondence', '.ui-autocomplete-item')
            .on('click.correspondence', '.ui-autocomplete-item', function(e) {
