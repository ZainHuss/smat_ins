...
@Named
@RequestScoped
public class PdfViewerBean implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4680515154750975992L;
	...
	public void init() {
		try {
			...
			String docPath = mainLocation + FileSystems.getDefault().getSeparator() + cabinet.getCode()
