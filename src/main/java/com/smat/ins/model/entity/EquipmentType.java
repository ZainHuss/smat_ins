...
/**
 * EquipmentType entity. @author MyEclipse Persistence Tools
 */
...
public class EquipmentType implements java.io.Serializable {
	...
	/** full constructor */
	public EquipmentType(String arabicName, String englishName, String code, Set equipmentInspectionForms) {
	...
	public boolean equals(Object other) {
		...
		return (other instanceof EquipmentType) && (id != null) ? id.equals(((EquipmentType) other).id)
				: (other == this);
	}
