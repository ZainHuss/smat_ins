...
/**
 * PriorityType entity. @author MyEclipse Persistence Tools
 */
...
public class PriorityType implements java.io.Serializable {
	...
	/** full constructor */
	public PriorityType(String arabicName, String englishName, String code, Set correspondenceRecipients,
			Set correspondences) {
	...
	public boolean equals(Object other) {
		...
		return (other instanceof PriorityType) && (id != null) ? id.equals(((PriorityType) other).id)
				: (other == this);
	}
