...
public class ItemType implements java.io.Serializable {
	...
	/** full constructor */
	public ItemType(String arabicName, String englishName, String code, Set generalEquipmentItems) {
	...
	public boolean equals(Object other) {
		...
		return (other instanceof ItemType) && (id != null) ? id.equals(((ItemType) other).id) : (other == this);
	}
