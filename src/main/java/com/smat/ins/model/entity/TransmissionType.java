...
/**
 * TransmissionType entity. @author MyEclipse Persistence Tools
 */
@Audited
public class TransmissionType implements java.io.Serializable {
	...
	/** full constructor */
	public TransmissionType(String arabicName, String englishName, String code, Set correspondenceTransmissions) {
	...
	public boolean equals(Object other) {
		...
		return (other instanceof TransmissionType) && (id != null) ? id.equals(((TransmissionType) other).id)
				: (other == this);
	}
