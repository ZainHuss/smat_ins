...
/**
 * PurposeType entity. @author MyEclipse Persistence Tools
 */

@Audited
public class PurposeType implements java.io.Serializable {
	...
	/** full constructor */
	public PurposeType(String arabicName, String englishName, String code, Set correspondenceRecipients) {
	...
	public boolean equals(Object other) {
		...
		return (other instanceof PurposeType) && (id != null) ? id.equals(((PurposeType) other).id)
				: (other == this);
	}
