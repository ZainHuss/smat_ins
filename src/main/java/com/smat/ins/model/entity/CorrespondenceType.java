...
public class CorrespondenceType implements java.io.Serializable {
	...
	/** full constructor */
	public CorrespondenceType(String arabicName, String englishName, String code, Set correspondences) {
	...
	public boolean equals(Object other) {
		...
		return (other instanceof CorrespondenceType) && (id != null) ? id.equals(((CorrespondenceType) other).id)
				: (other == this);
	}
