...
public class ExaminationType implements java.io.Serializable {
	...
	/** full constructor */
	public ExaminationType(String arabicName, String englishName, String code, Set equipmentInspectionForms) {
	...
	public boolean equals(Object other) {
		...
		return (other instanceof ExaminationType) && (id != null) ? id.equals(((ExaminationType) other).id)
				: (other == this);
	}
