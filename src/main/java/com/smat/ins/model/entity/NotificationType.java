...
public class NotificationType implements java.io.Serializable {
	...
	/** full constructor */
	public NotificationType(String arabicName, String englishName, String code, Set notifications) {
	...
	public boolean equals(Object other) {
		...
		return (other instanceof NotificationType) && (id != null) ? id.equals(((NotificationType) other).id)
				: (other == this);
	}
