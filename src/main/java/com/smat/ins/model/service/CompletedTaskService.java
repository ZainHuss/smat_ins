...
public interface CompletedTaskService extends GenericService<Task, Integer> {
    ...
    /**
     * Backfill completed_date for tasks whose workflows are at completed step '03' but completed_date is NULL.
     * This helps display correct results when DB was not updated by the workflow completion code.
     *
     ...
     */
    void backfillMissingCompletedDates(Date fromDate, Date toDate, Integer companyId, Short equipmentCategoryId);
}
