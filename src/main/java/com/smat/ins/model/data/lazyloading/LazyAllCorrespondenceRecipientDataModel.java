...
public class LazyAllCorrespondenceRecipientDataModel extends LazyDataModel<CorrespondenceRecipient> {
	/**
	 * 
	 */
	...
	public LazyAllCorrespondenceRecipientDataModel(List<CorrespondenceRecipient> dataSource) {
		super();
		this.dataSource = dataSource;
	}

	public LazyAllCorrespondenceRecipientDataModel(SysUser sysUserRecipient, CorrespondenceState correspondenceState) {
		super();
	...
	public LazyAllCorrespondenceRecipientDataModel(List<CorrespondenceRecipient> dataSource, SysUser sysUserRecipient,
	...
	public int count(Map<String, FilterMeta> filterBy) {
		// TODO Auto-generated method stub
		try {
			total = correspondenceRecipientService.getAllInboxCountBySysUser(sysUserRecipient, correspondenceState);
	...
	public List<CorrespondenceRecipient> load(int offset, int pageSize, Map<String, SortMeta> sortBy,
		...
		// TODO Auto-generated method stub
		try {
			dataSource = correspondenceRecipientService.getAllInboxBySysUser(sysUserRecipient, correspondenceState,
					offset, pageSize);
